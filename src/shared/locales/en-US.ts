export const EN_US_MESSAGES = {
    ...
    "api.error.invalid_response": "The server returned an invalid response",
...
`,
    ...
    "ai.assistant_description": "Summarize, polish, or draft Markdown with AI.",
    "ai.summarize": "Summarize",
    "ai.polish": "Polish",
    "ai.draft": "Draft",
    "ai.polish_selection": "Polish selection",
    "ai.summarize_insert": "Summarize and append",
    "ai.draft_here": "Draft here…",
    "ai.draft_prompt": "Enter a topic or instructions for the document",
    "ai.empty_content": "Select some text or open a non-empty note first",
    "ai.empty_topic": "Please enter a topic first",
    "ai.empty_result": "AI returned no content",
    "ai.request_failed": "AI request failed",
    "ai.generating": "Generating…",
    "settings.ai": "AI",
    "ai.status": "AI status",
    "ai.status_ready": "Configuration saved. Test the connection to verify this endpoint and model.",
    "ai.status_verified": "Connection verified · {latency} ms",
    "ai.status_not_configured": "Not configured. Enter your OpenAI API key to enable AI features.",
    "ai.api_key": "API key",
    "ai.api_key_description": "The OpenAI-compatible API key used to authenticate requests.",
    "ai.api_key_set_description": "A key is stored. Enter a new one to replace it, or leave blank to keep it.",
    "ai.api_key_placeholder": "sk-…",
    "ai.base_url": "Base URL",
    "ai.base_url_description": "Leave blank for the official OpenAI endpoint. Change it to use a compatible proxy or third-party service.",
    "ai.model": "Model",
    "ai.model_description": "The model name, e.g. gpt-4o-mini. Leave blank for the default.",
    "ai.image_model": "Image model",
    "ai.image_model_description": "The image generation model name, e.g. dall-e-3. Leave blank for the default. Ignored when using the Responses method.",
    "ai.image_method": "Image generation method",
    "ai.image_method_description": "The Generations method uses the /images/generations endpoint; the Responses method uses the built-in image_generation tool via /responses, for proxies that only support this approach (e.g. sub2api).",
    "ai.image_method_generations": "Generations",
    "ai.image_method_responses": "Responses",
    "ai.config_saved": "AI configuration saved",
    "ai.config_save_failed": "Failed to save AI configuration",
    "ai.config_load_failed": "Failed to load AI configuration",
    "ai.test_connection": "Test connection",
    "ai.testing_connection": "Testing…",
    "ai.connection_succeeded": "Connection successful",
    "ai.connection_failed": "Connection failed",
    "ai.connection_detail": "{model} · {latency} ms",
    "ai.loading_config": "Loading AI configuration…",
    "ai.owner_only": "Only the owner can configure AI.",
    "ai.usage_title": "How to use",
    "ai.usage_polish": "Select text in the editor, then choose “Polish selection” to refine it in place.",
    "ai.usage_summarize": "Select text or open a note, then choose “Summarize and append” to add a summary at the end.",
    "ai.usage_draft": "Choose “Draft here” to generate a new document from a topic and stream it into the editor.",
    "ai.draft_title": "Draft new content",
    "ai.draft_description": "Enter a topic or instructions. AI will stream content starting at the cursor.",
    "ai.draft_placeholder": "e.g. Introduce the advantages of Cloudflare Workers\nYou can also add instructions, e.g. Write a short, lighthearted essay about coffee",
    "ai.generate": "Generate",
    "ai.generating_with_task": "AI is {task}…",
    "ai.generating_hint": "Streaming into the editor. You can cancel anytime.",
    "ai.connecting": "Connecting…",
    "ai.writing": "Writing…",
    "ai.connecting_hint": "Connecting to the AI service…",
    "ai.streaming_progress": "Streaming smoothly · {count} characters received",
    "ai.cancel_generation": "Cancel generation",
    "ai.generation_canceled": "Generation canceled",
    "ai.task_polish": "polishing",
    "ai.task_summarize": "summarizing",
    "ai.task_draft": "drafting",
    "ai.polish_disabled_hint": "Requires a selection",
    "ai.summarize_disabled_hint": "Note must not be empty",
    "ai.shortcut_submit": "Press Cmd/Ctrl + Enter to generate",
    "ai.ask_ai": "Ask AI",
    "ai.ask_ai_to_edit": "Ask AI to edit",
    "ai.continue_writing": "Continue writing",
    "ai.make_longer": "Make longer",
    "ai.make_shorter": "Make shorter",
    "ai.fix_grammar": "Fix grammar",
    "ai.change_tone": "Change tone",
    "ai.translate": "Translate",
    "ai.suggest_placeholder": "Tell AI how to edit, or enter a topic…",
    "ai.suggest_draft_hint": "Enter a topic, AI will start writing at the cursor",
    "ai.suggest_edit_hint": "Describe the change, AI will replace the selection",
    "ai.replace": "Replace",
    "ai.insert_below": "Insert below",
    "ai.quick_actions": "Quick actions",
    "ai.draft_empty_hint": "Press Space on an empty line or click the AI icon",
    "ai.image_title": "Generate image",
    "ai.image_description": "Enter a prompt. AI will generate an image and insert it at the cursor.",
    "ai.image_prompt_placeholder": "Describe the image, e.g. an orange cat watching rain on a windowsill, watercolor style",
    "ai.image_size": "Size",
    "ai.image_size_square": "Square 1024×1024",
    "ai.image_size_landscape": "Landscape 1792×1024",
    "ai.image_size_portrait": "Portrait 1024×1792",
    "ai.image_generate": "Generate image",
    "ai.image_generating": "Generating image…",
    "ai.image_insert": "Insert into note",
    "ai.image_regenerate": "Regenerate",
    "ai.image_revised_prompt": "Revised prompt",
    "ai.image_failed": "Image generation failed",
    "ai.continue_hint": "AI will continue writing based on context",
    "ai.task_image": "generating image",
    "ai.task_edit": "editing",
    "ai.custom_instruction": "Custom instruction",
    "ai.image_size_hint": "Square for illustrations, landscape for scenes, portrait for people",
} as const;
