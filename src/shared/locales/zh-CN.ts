...
export const ZH_CN_MESSAGES = {
    ...
    "api.error.invalid_response": "服务器返回了无效响应",
...
`,
    ...
    "settings.ai": "AI",
    "ai.status": "AI 状态",
    "ai.status_ready": "配置已保存，建议测试接口地址和模型是否可用。",
    "ai.status_verified": "连接已验证 · {latency} ms",
    ...
    "ai.image_model": "图像模型",
    "ai.image_model_description": "图像生成模型名称，例如 dall-e-3。留空使用默认值。使用 Responses 方式时此项无效。",
    "ai.image_method": "图片生成方式",
    "ai.image_method_description": "标准方式使用 /images/generations 端点；Responses 方式使用 /responses 端点内置的 image_generation 工具，适用于仅支持该方式的代理（如 sub2api）。",
    "ai.image_method_generations": "标准 (Generations)",
    ...
    "ai.testing_connection": "测试中…",
    "ai.connection_succeeded": "连接成功",
    ...
    "ai.connecting": "正在连接…",
    "ai.writing": "正在写入…",
    "ai.connecting_hint": "正在连接 AI 服务…",
    "ai.streaming_progress": "正在丝滑写入 · 已接收 {count} 个字符",
    ...
    "ai.image_title": "生成图片",
    "ai.image_description": "输入提示词，AI 会生成图片并插入到光标处。",
    "ai.image_prompt_placeholder": "描述你想要的图片，例如：一只在窗台上看雨的橘猫，水彩风格",
    "ai.image_size": "尺寸",
    "ai.image_size_square": "正方形 1024×1024",
    "ai.image_size_landscape": "横向 1792×1024",
    "ai.image_size_portrait": "纵向 1024×1792",
    "ai.image_generate": "生成图片",
    "ai.image_generating": "正在生成图片…",
    "ai.image_insert": "插入到笔记",
    "ai.image_regenerate": "重新生成",
    "ai.image_revised_prompt": "AI 优化后的提示词",
    "ai.image_failed": "图片生成失败",
    "ai.continue_hint": "AI 会根据上下文继续写作",
    "ai.task_image": "生成图片",
    "ai.task_edit": "编辑",
    "ai.custom_instruction": "自定义指令",
    "ai.image_size_hint": "正方形适合配图，横向适合风景，纵向适合人物",
